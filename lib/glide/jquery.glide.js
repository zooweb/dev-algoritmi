...
;(function ($, window, document, undefined) {
	...
	var name = 'glide',
		defaults = {
			...
			arrowsWrapperClass: 'slider-arrows nav-fillpath',
			// {String} Main class for both arrows
			arrowMainClass: 'slider-arrow',
			// {String} Right arrow
			arrowRightClass: 'next',
			// {String} Right arrow text
			arrowRightText: '<span class="icon-wrap"><h3>Successivo</h3><span>',
			// {String} Left arrow
			arrowLeftClass: 'prev',
			// {String} Left arrow text
			arrowLeftText: '<span class="icon-wrap"><h3>Precedente</h3><span>',
